...
*The animation above shows the continuous analytic extension of the singular value spectrum across spin (s) and dimension (D). The heatmap visualizes how the constraint system's singular values σ₁, σ₂, σ₃ evolve, revealing special failure modes of scalar reduction at D=1 for s=3,4,5. This is the "Dariograph" - named for our coauthor Dario Francia - illustrating the landscape of gauge invariance conditions for higher-spin theories.*
...
- Visualization of singular value spectra illustrating failure modes of scalar reduction (the animated Dariograph above)
...
- **`GeneralSolution.gif`** - Animated Dariograph showing continuous evolution of singular values across (s,D) space
...
The animated Dariograph (`GeneralSolution.gif`) shown at the top of this README is generated by extending the Python script to produce animation frames:
